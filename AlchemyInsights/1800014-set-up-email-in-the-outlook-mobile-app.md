...
1. Pasirinkite **Pradėti** , jei tai pirmas kartas, kai el. pašto į mobilųjį app. kitaip nustatymas, bakstelėkite **meniu** ir **Parametrai** \> **Pridėti abonementą** \> **Įtraukti el. pašto paskyrą**. 
