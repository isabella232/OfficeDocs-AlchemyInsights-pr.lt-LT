...
1. Laiško rašymo srities apačioje pasirinkite **šriftą** arba **šrifto dydį**.
    
2. Pasirinkti šriftą arba šrifto dydį, kurį norite naudoti.
    
Jeigu nematote formatavimo parinkčių meniu kūrimo srities apačioje, pasirinkite **formatavimo parinktis**.
