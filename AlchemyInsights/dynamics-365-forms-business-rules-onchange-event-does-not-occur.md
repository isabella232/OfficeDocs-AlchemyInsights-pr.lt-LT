...
Įvykio *OnChange* nėra, jei laukas pakeičiamas programiškai naudojant *atributą.* [SetValue](https://docs.microsoft.com/dynamics365/customer-engagement/developer/clientapi/reference/attributes/setvalue) metodas. Jei norite, kad " *OnChange* " įvykis būtų paleistas nustačius reikšmę, turite naudoti " *formcontext. data. Entity" atributo* [fireonchange](https://docs.microsoft.com/dynamics365/customer-engagement/developer/clientapi/reference/attributes/fireonchange) metodą kodą.
