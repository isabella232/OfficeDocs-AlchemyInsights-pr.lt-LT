...
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>Failų naršyklę atidarykite SharePoint bibliotekoje

1. Eikite į biblioteką, esančią Internet Explorer 10 arba Internet Explorer 11. 
    
2. Spustelėkite Rodyti piktogramą, esančią viršutiniame dešiniajame kampe, ir tada spustelėkite **Peržiūrėti naršyklėje**.
