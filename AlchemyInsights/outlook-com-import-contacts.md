...
---
# <a name="import-contacts"></a>Kontaktų importavimas

Prieš importuodami kontaktus į "Outlook.com", turėsite juos eksportuoti iš kito elektroninio pašto teikėjo kaip. csv failą. Tada vadovaukitės toliau pateiktomis instrukcijomis.
...
.
2. Puslapio viršuje pasirinkite **tvarkyti** \> **kontaktų importavimą**.
3. Pasirinkite **Naršyti**, pereikite į aplanką, kuriame įrašėte eksportuotus kontaktus, ir pasirinkite **atidaryti**.

Norėdami sužinoti daugiau, peržiūrėkite [Kontaktų importavimas į Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).
