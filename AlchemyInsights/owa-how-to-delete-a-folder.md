...
---
# <a name="how-to-delete-a-folder"></a>Kaip panaikinti aplanką

1. Aplankų srityje dešiniuoju pelės mygtuku spustelėkite aplanką arba poaplankis, kurį norite naikinti.
2. Pasirinkite **ištrinti katalogą**.
