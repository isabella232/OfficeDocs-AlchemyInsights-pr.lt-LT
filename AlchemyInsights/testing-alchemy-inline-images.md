---
title: "\"Alchemy\" įdėtųjų vaizdų tikrinimas"
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "47669400"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="b7ac3-102">Prieiga prie domenų puslapio</span><span class="sxs-lookup"><span data-stu-id="b7ac3-102">Access the Domains Page</span></span>

<span data-ttu-id="b7ac3-103">Norėdami pasiekti puslapį domenai, tiesiog spustelėkite šią piktogramą:</span><span class="sxs-lookup"><span data-stu-id="b7ac3-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="b7ac3-104">Tada galite įtraukti, modifikuoti arba pašalinti savo domeną.</span><span class="sxs-lookup"><span data-stu-id="b7ac3-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="b7ac3-105">Daugiau informacijos rasite [domenų DUK.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="b7ac3-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
