...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="aceb2-102">Prieiga prie domenų puslapio</span><span class="sxs-lookup"><span data-stu-id="aceb2-102">Access the Domains Page</span></span>

<span data-ttu-id="aceb2-103">Norėdami prieiti prie domenų puslapį, tiesiog spustelėkite šią piktogramą žemiau:</span><span class="sxs-lookup"><span data-stu-id="aceb2-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="aceb2-104">Tada galite pridėti, modifikuoti arba pašalinti savo domeną.</span><span class="sxs-lookup"><span data-stu-id="aceb2-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="aceb2-105">Jei turite daugiau informacijos, peržiūrėkite [DUK apie domenus.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="aceb2-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
