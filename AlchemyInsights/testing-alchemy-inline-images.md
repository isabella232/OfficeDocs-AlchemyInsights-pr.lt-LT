...
ms.locfileid: "44505063"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="36c24-102">Prieiga prie domenų puslapio</span><span class="sxs-lookup"><span data-stu-id="36c24-102">Access the Domains Page</span></span>

<span data-ttu-id="36c24-103">Norėdami pasiekti domenų puslapį, tiesiog spustelėkite šią piktogramą žemiau:</span><span class="sxs-lookup"><span data-stu-id="36c24-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="36c24-104">Tada galite pridėti, modifikuoti arba pašalinti domeną.</span><span class="sxs-lookup"><span data-stu-id="36c24-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="36c24-105">Jei norite gauti daugiau informacijos, peržiūrėkite [domenų DUK.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="36c24-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
